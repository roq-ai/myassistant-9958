...
export const HelpBox: React.FC = () => {
  ...
  const customerRoles: string[] = ['Visitor'];
  const tenantRoles: string[] = ['Owner', 'Administrator', 'Facility Manager', 'Staff Member'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `myassistant`;
  const tenantName = `Client`;
